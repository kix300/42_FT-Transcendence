...
export class Game {
    ...
    constructor(engine: Engine, canvas: HTMLCanvasElement) {
        ...
        this.camera = new UniversalCamera('camera1', new Vector3(0, 5, -30), this.scene);
    ...
    createGameObjects(): void {
        ...
        // Create the paddles
        this.paddle1 = new Paddle('paddle1', new Vector3(-tableWidth / 2 + 1, 0.5, 0), tableDepth, this.scene);
        this.paddle2 = new Paddle('paddle2', new Vector3(tableWidth / 2 - 1, 0.5, 0), tableDepth, this.scene);

        // Create the game table (plane)
        const table = MeshBuilder.CreateGround('ground', { width: tableWidth, height: tableDepth }, this.scene);
    ...
    update(): void {
        ...
        this.ball.update([this.paddle1.mesh, this.paddle2.mesh], { width: 25, depth: 15 });
    }
}
