...
db.prepare("CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY, username TEXT UNIQUE, email TEXT UNIQUE, password TEXT, photo TEXT DEFAULT NULL, wins INTEGER DEFAULT 0, losses INTEGER DEFAULT 0)").run();
